<?php 
    ...
    session_start();
        ...
        $sql = "INSERT INTO work_temp (user_id, company, position, work_country, work_city, work_startdate, work_enddate)
            VALUES ($user_id, '$company', '$position', '$work_country', '$work_city', '$work_startdate', '$work_enddate')";
