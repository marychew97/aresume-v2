<?php 
    ...
    $sql = "UPDATE activities_temp 
            SET activity_country='$activity_country', activity_name='$activity', activity_city='$activity_city', activity_startdate='$activity_startdate', activity_enddate='$activity_enddate', activity_desc='$desc', photos='$images'
