          ...
          while($row = mysqli_fetch_assoc($result)){
            ?>
              <tr>
                ...
                <td><button class="btn" id="btn_edit"><a href="edit_resume.php?id=<?php echo $row['resume_id'];?>&user_id=<?php echo $id?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Edit<a></button></td>
